 ...
 * @returns the sum
 */
// selectiveSumer is a function that takes in f, and returns a function that takes in n
const selectiveSummer = f => n => {
    // definition of function that takes in n
 ...
 */
// filterSum is a variable that holds a function that takes in N, and returns a function that takes in f, that returns a function that sums, and calls it on n
